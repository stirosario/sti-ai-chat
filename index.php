...
<body>
  ...
  <section id="servicios" class="accent accent-blue">
    ...
    <div class="servicios-grid">
      <a class="servicio" href="/pcynotebook.html"><h3><span class="icono emoji">🖥</span> REPARACIONES DE PC - NOTEBOOK</h3><p>Reparación, actualización y reemplazo de hardware.</p></a>
 ...
 // ====== WhatsApp ticket ======
  ...
  async function sendButton(value, label){
    ...
    try {
      ...
      if (valLower.includes('lo pude solucionar') || lblLower.includes('lo pude solucionar') || 
          valLower.includes('ya lo solucioné') || lblLower.includes('ya lo solucioné') ||
          valLower.includes('btn_solved')) {
         ...
         if (send) {
           ...
           */
           ...
           send.onclick = (e) => {
             e.preventDefault();
             e.stopPropagation(); // Intentar detener otros handlers si es posible
             stiHideChat();
           };
         }
      }
